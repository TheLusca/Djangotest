...
SECRET_KEY = 'django-insecure-a=^1qbw4h_u3bmz+i)x0%nix5$#jl@kcq8ws#gq!r1hkfokl_^'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG com valor True = MODO DESENVOLVIMENTO
# DEBUG com valor False = MODO PRODUÇÃO(SISTEMA PRONTO PRA USO)
DEBUG = False
